...
public class GetIDFromYOUTUBE2 {
...
public void PostVideo(){
 ...
 //  request.header("AuthToken",AccessToken);	 
	...
	System.out.println("Status Code is:"+code);
      ...
      String[] arr= {"VidioId", "VidioId", "VidioId", "VidioId", "VidioId", "VidioId", "VidioId", "VidioId", "VidioId", "VidioId", "VidioId"};
      int size=arr.length;
      Random rand = new Random(); 
      int rand_int1 = rand.nextInt(size); 

      String[] abc =data.split(arr[rand_int1]);
      int b= abc.length;
	  System.out.println(b);

	  String VID_ID=AccessToken.substring(4, 16);
