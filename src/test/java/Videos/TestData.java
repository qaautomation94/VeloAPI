...
public class TestData {
	...
	public static String GetAllSpecials="api/v5/specials/";
	public static String GetSpecialsByID="api/v5/specials/";
	public static String PostSpecial="api/v5/specials/";
	public static String DeleteSpecial="api/v5/specials/";
