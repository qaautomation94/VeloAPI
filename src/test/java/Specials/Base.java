...
public class Base {
	...
	protected int ProductCount1;

	protected int VideoCount;
	protected int VideoCount1;
 ...
 public void TokenGeneration(){
	    ...
	    request.body(json.toJSONString());
		 ...
		 resp=request.post("https://productservice.asicentral.com/api/v4/Login");
 ...
 public void ExtentReport(){
	...
	ExtentHtmlReporter htmlReporter;
		...
		extent.setSystemInfo("URL", EspUpdate.BaseUrl);
